...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mBtnCallCadastrar = (Button)findViewById(R.id.btn_call_cadastrar);
        mBtnCallCadastrar.setOnClickListener(new OnClickListener() {
            @Override
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            HttpPost clientPost = new HttpPost("http://buddy.tecnologia.ws/oauth/token");
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("client_secret", "IH4lxjIekHZ6gAcVixC3eerznO2iX0eOB07h1mgN"));
                ...
                if(codeStatus != null && codeStatus != 401){
                    ...
                    userSession.setUser(result.getString("access_token"));
                    retunValue = true;
                }
